...
CUDA_LAUNCH_BLOCKING=1 python generate_patient_summary.py --json_name "dropped_rerun.csv" --start_id 0 --end_id 1000000 --directory_path "/projectnb/vkolagrp/skowshik/foundation_adrd/adrd-foundation-model/data/nacc/training_data/training_data_grpo" --model_id "Qwen/Qwen3-32B" --n_devices 4 --batch_size 1000 --max_new_tokens 2000 --data_path "/projectnb/vkolagrp/skowshik/foundation_adrd/adrd-foundation-model/data/nacc/training_data/training_data_grpo/dropped.csv"